...
import SvgVue from 'svg-vue3/src/svg-vue.vue';

describe('svg-vue3 (Vue 3)', () => {
    it('renders the referenced SVG inline as an <svg> element', () => {
        const wrapper = mount(SvgVue, { props: { icon: 'avatar' } });
    ...
    it('resolves the dot notation to a nested path', () => {
        const wrapper = mount(SvgVue, { props: { icon: 'fontawesome.check' } });
